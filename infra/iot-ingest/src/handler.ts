...
const VARIABLE_MAP: Record<string, string> = {
  ...
  'Power/var/Inst/Value/Sum': 'reactive_power_var',
  ...
  'Frequency/Inst/Value': 'frequency_hz',
  'Energy/W/Imp/Total/Value': 'energy_import_wh',
  'Energy/W/Exp/Total/Value': 'energy_export_wh',
  'Energy/var/Imp/Total/Value': 'reactive_energy_import_varh',
  ...
  'THD/I/Inst/Value/L1': 'thd_current_l1_pct',
  'THD/I/Inst/Value/L2': 'thd_current_l2_pct',
  'THD/I/Inst/Value/L3': 'thd_current_l3_pct',
