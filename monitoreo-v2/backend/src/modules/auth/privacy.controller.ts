      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            'Oposición: oponerse al tratamiento de datos (bloquea acceso a la plataforma)',
            'Bloqueo: suspender temporalmente el procesamiento durante una disputa',
            'Portabilidad: recibir datos en formato estructurado (JSON)',
            'Decisiones automatizadas: excluirse de notificaciones y escalamientos automatizados',
          ],
        ...
        },
        {
          ...
          items: [
            ...
            'Cifrado PII a nivel de columna (AES-256-GCM)',
          ],
        },
        {
          title: 'Decisiones Automatizadas',
          content: 'La plataforma utiliza un motor de alertas que evalúa automáticamente lecturas de medidores y escala alertas por severidad. Estas decisiones son operativas (infraestructura energética) y no producen efectos jurídicos sobre personas. Puedes excluirte de las notificaciones automatizadas desde tu perfil.',
        },
        {
          title: 'Edad Mínima',
          content: 'Esta plataforma está dirigida a usuarios mayores de 14 años. La creación de cuentas requiere confirmación de edad por parte del administrador, conforme al Art. 16 quáter de la Ley 21.719.',
        },
      ],
    };
  }
