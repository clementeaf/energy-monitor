...
import type { TenantUnitImportFileFormat } from '../tenant-unit-import.types';
...
@Entity('tenant_unit_import_jobs')
export class TenantUnitImportJob {
  ...
  fileFormat!: TenantUnitImportFileFormat;
