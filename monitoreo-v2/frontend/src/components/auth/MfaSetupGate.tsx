...
export function MfaSetupGate() {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-lg bg-background p-8 shadow-2xl">
        ...
        <h2 className="text-lg font-semibold text-foreground">Configura la verificación en dos pasos</h2>
        ...
        <ol className="mt-3 space-y-1.5 text-sm text-muted">
          <li className="flex items-start gap-2">
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-raised text-xs font-semibold text-foreground">1</span>
            <span>Descarga <strong>Google Authenticator</strong> o <strong>Microsoft Authenticator</strong> en tu celular</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-raised text-xs font-semibold text-foreground">2</span>
            <span>Escanea un código QR que te mostraremos</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-raised text-xs font-semibold text-foreground">3</span>
        ...
        <button
          ...
          className="mt-6 w-full rounded-lg bg-brand px-4 py-2.5 text-sm font-medium text-brand-fg hover:opacity-90"
        >
          Configurar ahora
        </button>
      </div>
