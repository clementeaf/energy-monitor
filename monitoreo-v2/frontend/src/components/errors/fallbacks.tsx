    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <button
          type="button"
          onClick={reset}
          className="rounded-md bg-amber-900 px-4 py-2 text-sm font-medium text-brand-fg hover:bg-amber-800"
        >
          Reintentar
        </button>
        <Link
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center gap-4 bg-raised p-8 text-center" role="alert">
      ...
      <button
        type="button"
        onClick={reset}
        className="rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-brand-fg hover:bg-gray-800"
      >
        Reintentar
      </button>
    </div>
