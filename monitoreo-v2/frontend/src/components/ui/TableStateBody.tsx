            ...
            <div className="flex flex-col items-center gap-3">
              ...
              {onRetry && (
                <button
                  type="button"
                  onClick={onRetry}
                  className="rounded-md border border-danger/50 px-3 py-1.5 text-xs font-medium text-danger hover:bg-danger/10"
                >
                  Reintentar
                </button>
              )}
        ...
        <tr>
          <td colSpan={colSpan} className="px-4 py-12 text-center">
            <div className="flex flex-col items-center gap-2">
              <svg className="h-8 w-8 text-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
