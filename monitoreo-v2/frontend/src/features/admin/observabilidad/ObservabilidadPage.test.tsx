...
describe('ObservabilidadPage', () => {
  ...
  it('renders health KPIs', () => { renderPage(); expect(screen.getByText('Uptime (30d)')).toBeInTheDocument(); expect(screen.getByText('Latencia media')).toBeInTheDocument(); expect(screen.getByText('Error rate')).toBeInTheDocument(); });
